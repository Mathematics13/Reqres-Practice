...
public class PropertyReader {
    ...
    public String getProperty(String propertyName) {
        ...
        try {                                                                         //Change path from config.properties
...
//resources directory under test
//properties file - directory under resources
//config.properties - file under properties file
